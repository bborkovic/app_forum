...
class User extends DatabaseObject {
	...
	public static $db_fields = array('id','username','password','first_name','last_name','email', 'created_at', 'updated_at');
	public static $primary_keys = array('id');
	public static $admin_keys = array('created_at', 'updated_at');
